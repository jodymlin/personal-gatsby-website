...
class ButtonBar extends React.Component{
    render() {
        ...
        const MenuButton = function ({to, isSection, ...props}) {
            if (isSection) {
                return <a href={to} className={classes.link}>
                    <Button fullWidth={isMobile} {...props}/>
                    </a>
            }
            else {
        ...
        return (
            ...
            <MenuButton isSection to={'/#about-me'}>About</MenuButton>
            <MenuButton isSection to={'/#resume'}>Resume</MenuButton>
            <MenuButton isSection to={'/#projects-and-more'}>Projects+More!</MenuButton>
